...
class InsetGraphElement {
    constructor(el, props, state) {
        let svg = d3.select(el).append('svg').attr("class", "inset-graph").attr("width", props.width).attr("height", props.height);
    }
}
...
class InsetGraph extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { className: "inset-graph" });
    }
